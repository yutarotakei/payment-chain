...
> fabric-contract-api@2.5.8 lint
...
> fabric-contract-api@2.5.8 test:unit
> npm run test


> fabric-contract-api@2.5.8 test
> nyc mocha --recursive 'test/unit/**/*.js'
  ...
  Default.js
    Default
2024-12-04T09:27:11.473Z info [c-api:./lib/annotations/default.js]                @Default args: "Target ->","mockTarget" 
      ✔ should add set value for default when none set
2024-12-04T09:27:11.477Z info [c-api:./lib/annotations/default.js]                @Default args: "Target ->","mockTarget" 
      ✔ should error when default already set

  Info.js
    Info
2024-12-04T09:27:11.479Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when no objects exist for global yet
2024-12-04T09:27:11.481Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when objects exist for global
    Info with data
2024-12-04T09:27:11.482Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when no objects exist for global yet
2024-12-04T09:27:11.484Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when objects exist for global

  Object.js
    #Object
2024-12-04T09:27:11.486Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
      ✔ should add object as key when no objects exist for global yet
2024-12-04T09:27:11.488Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
      ✔ should add object as key when objects exist for global
2024-12-04T09:27:11.489Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
      ✔ should add object with no supertype
2024-12-04T09:27:11.491Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
  ...
  Transaction.js
    Transaction
2024-12-04T09:27:11.497Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should handle existing transactions
2024-12-04T09:27:11.499Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should error if missing type
2024-12-04T09:27:11.500Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should handle existing transactions of which matches name and already has param metadata
2024-12-04T09:27:11.502Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should create new metadata for fabric:transactions if none exist and handle no params
2024-12-04T09:27:11.503Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> false,","Target ->","Object" 
      ✔ should not add a tag if commit is false
    Returns
2024-12-04T09:27:11.505Z info [c-api:./lib/annotations/transaction.js]            @Returns args: ", Property Key -> mockKey, Return Type -> someType,","Target ->","Object" 
      ✔ should handle existing transactions
2024-12-04T09:27:11.506Z info [c-api:./lib/annotations/transaction.js]            @Returns args: ", Property Key -> mockKey, Return Type -> someType,","Target ->","Object" 
      ✔ should handle when there are no existing transactions
    Param
2024-12-04T09:27:11.508Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should overwrite when the transaction exists and param of name already in
2024-12-04T09:27:11.510Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should overwrite existing transaction but add new param when one with name does not exist
2024-12-04T09:27:11.511Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should append to transaction a new parameters array when transaction exists but has not parameters field
2024-12-04T09:27:11.513Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should handle when no transaction exists
2024-12-04T09:27:11.514Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> undefined,","Target ->","Object" 
...
2024-12-04T09:27:11.521Z error [c-api:./lib/contract.js]                          [some id] Contract contract-api.Contract unknown transaction "wibble", 
...
2024-12-04T09:27:11.528Z error [c-api:./lib/jsontransactionserializer.js]         undefined toBuffer validation against schema failed on type "number","string" 
...
2024-12-04T09:27:11.532Z error [c-api:./lib/jsontransactionserializer.js]         undefined fromBuffer no data supplied  
      ✔ should throw an error if nothing given
      ✔ should throw an error if not a number
      ✔ should throw an error if bad boolean given
2024-12-04T09:27:11.534Z error [c-api:./lib/jsontransactionserializer.js]         fromBuffer could not parse data as JSON to allow it to be converted to type: "some type" "trie",{} 
2024-12-04T09:27:11.534Z error [c-api:./lib/jsontransactionserializer.js]         Converting data to string and JSON.stringify-ing  
  ...
  Logger
    ✔ coverage
2024-12-04T09:27:11.539Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
2024-12-04T09:27:11.539Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
    getLogger
...
> fabric-contract-api@2.5.8 test:schema
